            ...
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <a type="button" href="{{url('/advertisments/create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Advertisment</a>

                        <div class="box-tools">
                            {!! Form::open(['url' => '/advertisments/filter', 'method' => 'GET']) !!}
                                ...
                                @foreach($advertisments as $advertisment)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/advertisments')}}/{{$advertisment->id}}/edit" title="edit details" class="actions"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
