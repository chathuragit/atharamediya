...
@section('content')
    <section class="content-header">
        <h1>
            ...
            <small>Create Advertisement Collector</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-6 col-xs-offset-3">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Create Advertisement Collector</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    {!! Form::open(['url' => 'advertisement_collectors/', 'method' => 'POST', 'files'=>true]) !!}
                    <div class="box-body">
