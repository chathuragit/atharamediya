            ...
            <div class="col-xs-6 col-xs-offset-3">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">View Attribute</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('attribute_name') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Attribute Name" name="attribute_name" value="{{$Attribute->attribute_name}}" readonly>
                        ...
                        <div class="form-group {{ $errors->has('attribute_values') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Attribute Values" name="attribute_values" value="{{$Attribute->attribute_values}}" readonly>
                        ...
                        <div class="form-group {{ $errors->has('attribute_type') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="attribute_type" readonly>
                    ...
                    <div class="box-footer">
                        <a  href="{{url('/attributes')}}" class="btn btn-success pull-right">Close</a>
                    </div>
