                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('category_name') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Category Name" name="category_name" value="{{$Category->category_name}}" readonly>
                        ...
                        <div class="form-group {{ $errors->has('default_attribute') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="default_attribute" readonly>
                    ...
                    <div class="box-footer">
                        <a  href="{{url('/categories')}}" class="btn btn-success pull-right">Close</a>
                    </div>
