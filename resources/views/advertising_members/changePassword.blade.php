...
@section('content')
    <section class="content-header">
        <h1>
            Advertising Members
            <small>Change Advertising Member Password</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-6 col-xs-offset-3">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><strong>Change Advertising Member User's Password <small>({{$User->name}})</small></strong></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    {!! Form::open(['url' => 'advertising_members/change_password/', 'method' => 'POST']) !!}
                    <div class="box-body">
