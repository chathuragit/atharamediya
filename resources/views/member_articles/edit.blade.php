        ...
        <div class="row">
            <div class="col-xs-6 col-xs-offset-3">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    {{ Form::model($Article, array('route' => array('member_articles.update', $Article->id), 'method' => 'PUT')) }}
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                            <label>Title</label>
                            <input type="text" class="form-control" placeholder="Enter Title" name="title" value="{{$Article->title}}" required>
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <textarea name="description" class="form-control" required>{{$Article->desc}}</textarea>
                    ...
                    <div class="box-footer">
                        <a  href="{{url('/member_articles')}}" class="btn btn-default pull-left">Close</a>
